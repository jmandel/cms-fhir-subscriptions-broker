...
`Patient/source-456` uses the source-scoped bare patient ID from the token response at this endpoint (§4.1), prefixed with `Patient/` for use as a FHIR reference in the filter.
